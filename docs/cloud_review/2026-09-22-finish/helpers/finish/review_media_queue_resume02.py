...
Run through record.py review_media_queue02 after the earlier review queue ends.
...
def main():
    ...
    log_path = run / 'review_media_queue02.jsonl'
    summary_path = run / 'review_media_queue02.json'
