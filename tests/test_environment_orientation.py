...
@pytest.mark.parametrize('quaternion',[(0,0,0,0),(2,0,0,0),(float('nan'),0,0,0),(float('inf'),0,0,0)])
...
def test_only_optical_scene_rotates_environment():
    for entry in list_scenes():
        ...
        expected=(.594394087626887,.1712372678360988,-.2126979877009283,.7563947598484568) if spec.scene_id=='optical_bench' else (1,0,0,0)
