...
p=argparse.ArgumentParser();p.add_argument('--url',default='http://127.0.0.1:8780');p.add_argument('--out',default='runs/viser_actual.png');a=p.parse_args()
...
with sync_playwright() as pw:
 ...
 page.goto(a.url,wait_until='domcontentloaded');page.wait_for_timeout(6000)
