...
SOURCE_DIRECTORIES=('src','scripts','configs','scenes','prompts','tests','assets','docs',
                    'schemas','scene_agent','.claude')
SOURCE_FILES=('pyproject.toml','requirements-simulation.txt','README.md','AGENTS.md',
              'GOAL_EXECUTION_PROMPT.md','CLAUDE.md','.env.example','.gitignore')
