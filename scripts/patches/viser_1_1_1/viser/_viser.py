...
class CameraHandle:
    ...
    def aspect(self) -> float:
        """Camera projection aspect, independent of image pixel rounding. Not assignable."""
        assert self._state.update_timestamp != 0.0
        return self._state.projection_aspect
        ...
        async def _(conn: infra.WebsockClientConnection) -> None:
            ...
            async def handle_camera_message(
                ...
                client.camera._state = _CameraHandleState(
                    ...
                    fov=message.fov,
                    projection_aspect=message.projection_aspect,
