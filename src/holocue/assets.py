...
def world_scene(root: Path, spec: SceneSpec, poses: dict[str, Pose] | None = None) -> trimesh.Scene:
    ...
    entries = [(o.object_id, o.asset, poses.get(o.object_id, o.pose), (1.0, 1.0, 1.0)) for o in spec.objects]
